...
if [[ " ${platforms[*]} " == *" android "* ]]; then
    ...
    ${ANDROID_ZIPALIGN} -vf 4 platforms/android/build/outputs/apk/android-x86-release-unsigned.apk ./build/wpbmchs-android-x86.apk
    ...
    ${ANDROID_ZIPALIGN} -vf 4 platforms/android/build/outputs/apk/android-armv7-release-unsigned.apk ./build/wpbmchs-android-armv7.apk
fi
