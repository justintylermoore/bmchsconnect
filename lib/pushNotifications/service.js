export default class {
    constructor($injector, $q, $WPBMCHSConfig, $log, $state, $http, $filter, WpApi, $WPBMCHSLanguage) {
        'ngInject';
        this.$q = $q;
        this.WpApi = WpApi;
        this.$log = $log;
        ...
        this.$filter = $filter;
        this.$http = $http;
        this.$WPBMCHSLanguage = $WPBMCHSLanguage;
        this.$WPBMCHSConfig = $WPBMCHSConfig;
        this.token = null;
        this.os = null;
        this.instance = null;
        this.androidConfig = _.get($WPBMCHSConfig, 'cordova.pushNotifications.android');
        this.iosConfig = _.get($WPBMCHSConfig, 'cordova.pushNotifications.ios');
    ...
    hasBeenRegistered() {
        ...
        var baseUrl = _.get(this.$WPBMCHSConfig, 'cordova.pushNotifications.baseUrl');
        if (!baseUrl) {
            return this.$q.reject();
        }
        return this.$http({
    ...
    httpPost(endpoint = '/register', data = {}) {
        ...
        return this.$http({
            ...
            data: angular.merge({
                os: this.os,
                token: this.token,
                lang: this.$WPBMCHSLanguage.getLocale()
            }, data)
        });
    };
    ...
    confirmNewContent(postId, postMsg) {
        ...
        text = this.$filter('translate')('pushNotifications.newContent.text', {
            postTitle: postMsg,
            appTitle: _.get(this.$WPBMCHSConfig, 'title' || '')
        });
