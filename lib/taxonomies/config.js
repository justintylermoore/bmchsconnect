        ...
        .state('public.taxonomies', {
            ...
            views: {
                'content': {
                    ...
                    controller: "WPBMCHSTaxonomiesController as taxonomiesCtrl"
                }
            }
        })
        .state('public.taxonomies.slug', {
            url: "/:slug",
            class: 'module-taxonomies-<%=term%>-<%=postType%>-<%=slug%>',
            params: {
                taxonomy: null
            },
            views: {
                'content@public': {
                    ...
                    controllerProvider: function($stateParams) {
                        if ($stateParams.postType != 'post') {
                            return "WPBMCHSTaxonomiesPostsController as customPostsCtrl";
                        }
                        return "WPBMCHSTaxonomiesPostsController as postsCtrl";
                    }
                }
            }
        });
